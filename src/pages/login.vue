  ...
  >
    <v-row class="justify-center align-center w-100 h-100 ma-0">
      <v-col cols="12" sm="8" md="4">
        <v-card elevation="8" min-height="600px" rounded="xl" class="px-2 px-md-5 px-md-10 py-6 blur-bg d-flex flex-column justify-center">
          <v-card-title class="text-center d-flex flex-column align-center">
            <v-img
              src="/src/assets/FITCertify365_Logo1.png"
              alt="Logo"
              width="300"
              contain
            ></v-img>
            <div
              class="text-h6 font-weight-medium text-grey-darken-2 w-100 text-center mt-10"
            >
          ...
          <v-card-text class="pt-0 mt-5">
            <v-form>
              ...
              <label class="text-white text-subtitle-1" for="inputSenha"
                >Senha</label
              >
              <v-text-field
                v-model="data.senha"
