  ...
  >
    <v-row no-gutters class="h-100">
      ...
      <v-dialog v-model="showModal" width="600" persistent>
        <v-card rounded="xl" :loading="loading" :disabled="loading">
          <v-btn variant="text" width="20px" height="50px">
            <span
              @click="voltar"
              class="mdi mdi-window-close text-h5"
              style="color: #00c6fe"
            ></span>
          </v-btn>
          <v-card-title
            class="d-flex flex-column justify-center align-center ga-5 mt-5 px-5 px-md-10"
          >
            <span
              class="mdi mdi-email-fast-outline text-h1"
              style="color: #00c6fe"
            ></span>
            <span class="text-h6 text-md-h5 font-weight-bold"
              >Verifique sua conta</span
            >
          </v-card-title>
          <v-card-subtitle
            class="text-center text-subtitle-2 text-md-subtitle-1 px-md-10"
          ...
          <v-card-actions
            class="d-flex w-100 flex-column-reverse ga-5 px-5 px-md-10 mb-5"
          >
      ...
      >
        ...
        <!-- Formulário -->
        <p
          class="text-white text-center text-subtitle-1 text-md-h6 text-lg-h5 px-lg-10"
        ...
        <v-form
          class="d-flex align-center flex-column px-lg-0 px-xl-12 h-auto"
          ref="formRef"
        >
          <v-text-field
            v-model="novaSenha"
          ...
          <VRow class="d-flex w-100 mt-5">
            <div class="d-flex flex-column align-center w-100" cols="12">
              ...
              <div
                class="d-flex flex-column flex-md-row align-center justify-center mt-10"
              >
                <span class="text-white text-md-subtitle-2 text-lg-subtitle-1"
                  >Lembrou da senha?</span
                >
                <button
                  @click="voltar"
