<template>
  <v-navigation-drawer v-model="layoutStore.drawer" :rail="layoutStore.rail" permanent
    ...
    style="position: fixed !important; height: 100vh !important; top: 0; left: 0;">
    <!-- Header -->
    <div class="pa-4 text-center header-section">
      ...
      <div v-else>
        ...
        <div class="d-flex align-center"> <v-img src="/src/assets/Camada_1.png" alt="Logo" width="150" class="mb-3"
            contain></v-img></div>
